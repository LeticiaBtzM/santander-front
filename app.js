/*
    cuando una variable se declara con const ésta no puede cambiar en su valor y siempre debe ser asignada
    cuando una variable se declara con let ésta puede cambiar en su valor
*/
